...
let package = Package(
    ...
    targets: [
        .target(name: "DiscoveryV1", dependencies: ["IBMSwiftSDKCore"], path: "Sources/DiscoveryV1", sources: ["Models", "Discovery.swift", "Shared.swift" , "../SupportingFiles/InsecureConnection"]),
